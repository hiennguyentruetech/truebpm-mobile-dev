...
/// Custom date range calendar widget
class CustomDateRangeCalendar extends StatefulWidget {
  ...
  @override
  State<CustomDateRangeCalendar> createState() => _CustomDateRangeCalendarState();
}
...
class _CustomDateRangeCalendarState extends State<CustomDateRangeCalendar> {
  ...
  void initState() {
    super.initState();
    currentMonth = widget.startDate ?? DateTime.now();
  ...
  Widget _buildCalendarGrid(Color primaryColor, int daysInMonth, int firstWeekday) {
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final isStartDate = tempStartDate != null && _isSameDay(date, tempStartDate!);
        final isEndDate = tempEndDate != null && _isSameDay(date, tempEndDate!);
          ...
          child: Container(
            ...
            child: Center(
              child: Text(
                ...
                style: TextStyle(
                  fontSize: 16,
                  fontWeight: (isStartDate || isEndDate) ? FontWeight.w600 : FontWeight.w400,
                  color: (isStartDate || isEndDate)
                    ? Colors.white
                    : isDisabled
  ...
  void _handleDateTap(DateTime date) {
    ...
    widget.onRangeChanged(tempStartDate, tempEndDate);
  }
