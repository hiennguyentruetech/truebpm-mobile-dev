...
class _CoreTreeState extends State<CoreTree> with TickerProviderStateMixin {
  ...
  bool _isActionAllowedByPermission(
    String actionType, [
    Map<String, dynamic>? item,
  ]) {
  ...
  List<Map<String, dynamic>> _filterItemsByPermissions(
  ...
  List<Map<String, dynamic>> _getAccessibleItemsWithParents(
    List<Map<String, dynamic>> items,
  ) {
  ...
  Map<String, dynamic> _applyDefaultValuesOnSave(
  ...
  List<Map<String, dynamic>> _buildNestedTreeFromFlat(
  ...
  void _updateTreeDataSilent() {
    ...
    final List<Map<String, dynamic>> nestedRoots = _buildNestedTreeFromFlat(
      _treeData,
    );
  ...
  Widget _buildTreeItem(Map<String, dynamic> item, int index) {
    ...
    final cardBody = Column(
      ...
      children: [
        ...
        InkWell(
          onTap: (widget.allowEdit && _isActionAllowed('edit', item))
          ...
          child: Row(
            children: [
              ...
              if ((widget.footerActions ?? const []).isNotEmpty &&
                  _isActionAllowed('footerActions', item))
              ...
              child: _currentItems.isEmpty
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) =>
                          _buildTreeItem(_currentItems[index], index),
                    ),
            ),
          ],
        ),
            ...
            child: AnimatedBuilder(
              ...
              builder: (context, child) {
                return Transform.scale(
                  ...
                  child: FloatingAddButton(onPressed: _addNewItem),
                );
              },
            ),
          ),
